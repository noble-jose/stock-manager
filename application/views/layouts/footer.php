					...
					<div class="footer py-4 d-flex flex-lg-column" id="kt_footer">
						...
						<div class="container-fluid d-flex flex-column flex-md-row align-items-center justify-content-between">
							...
							<div class="text-dark order-2 order-md-1">
								...
								<a href="https://keenthemes.com" target="_blank" class="text-gray-800 text-hover-primary">codecraftmedia.in</a>
							</div>
							<!--end::Copyright-->
							<!--begin::Menu-->
									...
									<div data-kt-stepper-element="content">
										<div class="w-100 text-center">
											...
											<div class="text-center px-4 py-15">
												<img src="assets/dashboard/media/illustrations/todo.png" alt="" class="mw-100 mh-150px" />
											</div>
											<!--end::Illustration-->
										</div>
									</div>
		...
		<script src="<?= base_url('assets/dashboard/plugins/global/plugins.bundle.js')?>"></script>
		<script src="<?= base_url('assets/dashboard/js/scripts.bundle.js')?>"></script>
		<!--end::Global Javascript Bundle-->
		<!--begin::Page Vendors Javascript(used by this page)-->
		<script src="<?= base_url('assets/dashboard/plugins/custom/fullcalendar/fullcalendar.bundle.js')?>"></script>
		<!--end::Page Vendors Javascript-->
		<!--begin::Page Custom Javascript(used by this page)-->
		<script src="<?= base_url('assets/dashboard/js/custom/widgets.js')?>"></script>
		<script src="<?= base_url('assets/dashboard/js/custom/apps/chat/chat.js')?>"></script>
		<script src="<?= base_url('assets/dashboard/js/custom/modals/create-app.js')?>"></script>
		<script src="<?= base_url('assets/dashboard/js/custom/modals/upgrade-plan.js')?>"></script>
